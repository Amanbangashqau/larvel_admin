              ...
              <div class="col-12 col-md-6 col-lg-12" style="user-select: auto;">
                <div class="card" style="user-select: auto;">
                  <div class="card-header" style="user-select: auto;">
                    ...
                    <h4 style="user-select: auto;">Add Technician</h4>
                  </div>
                  <form action="save_technician" method="POST" enctype="multipart/form-data" style="user-select: auto;">
                ...
                <div class="row" style="user-select: auto;">
                    ...
                    <div class="form-group" style="user-select: auto;">
                      ...
                      <select name="service_id" class="form-control" style="user-select: auto;">
                        ...
                        @foreach ($services as $service)
                         <option value="{{$service->id}}" style="user-select: auto;">{{$service->service_name}} </option>
                        @endforeach
                      </select>
                 ...
                 <div class="row" style="user-select: auto;">
                    ...
                    <div class="form-group" style="user-select: auto;">
                      ...
                      <input type="text" name="mobile_no" class="form-control" style="user-select: auto;">
                    </div>
                  </div>
                    <div class="col-12 col-md-6 col-lg-6" style="user-select: auto;">
                    <div class="form-group" style="user-select: auto;">
                ...
                <div class="row" style="user-select: auto;">
                   ...
                   <div class="form-group" style="user-select: auto;">
                     ...
                     <input name="bank_mailing_address" type="text" class="form-control" style="user-select: auto;">
                   </div>
                 </div>
                   <div class="col-12 col-md-6 col-lg-6" style="user-select: auto;">
                   <div class="form-group" style="user-select: auto;">
                     <label style="user-select: auto;">Bank's Routing Number</label>
                     <input name="bank_routing_number" type="text" class="form-control" style="user-select: auto;">
                   </div>
                 </div>
               ...
               <div class="row" style="user-select: auto;">
                  ...
                  <div class="form-group" style="user-select: auto;">
                    ...
                    <input name="account_number" type="text" class="form-control" style="user-select: auto;">
                  </div>
                </div>
                  <div class="col-12 col-md-6 col-lg-6" style="user-select: auto;">
                  <div class="form-group" style="user-select: auto;">
                    <label style="user-select: auto;">Type of Account</label>
                    <input name="account_type" type="text" class="form-control" style="user-select: auto;">
                  </div>
                </div>
