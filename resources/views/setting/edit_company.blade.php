              ...
              <div class="col-12 col-md-6 col-lg-12" style="user-select: auto;">
                <div class="card" style="user-select: auto;">
                  <div class="card-header" style="user-select: auto;">
                    <h4 style="user-select: auto;">Edit Company</h4>
                    <a href="javascript:history.back()" style="float:right;" class="btn btn-primary pull-right">Back</a>
                  </div>
                  <form action="{{ url('update_company') }}" method="POST" style="user-select: auto;">
                        ...
                        <div class="card-body" style="user-select: auto;">
                          ...
                          <div class="row" style="user-select: auto;">
                            <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                              ...
                              <input name="name" type="text" value="{{$company->name}}" class="form-control" style="user-select: auto;">
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          <div class="form-group" style="user-select: auto;">
                            ...
                            <input name="email" value="{{$company->email}}" type="email" class="form-control" style="user-select: auto;">
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          <div class="form-group" style="user-select: auto;">
                            ...
                            <input name="address" value="{{$company->address}}" type="text" class="form-control" style="user-select: auto;">
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          <div class="form-group" style="user-select: auto;">
                            ...
                            <input name="phone_number" value="{{$company->phone_number}}" type="text" class="form-control" style="user-select: auto;">
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          <div class="form-group" style="user-select: auto;">
                            ...
                            <input name="work_sync_email" value="{{$company->work_sync_email}}" type="text" class="form-control" style="user-select: auto;">
                    ...
                    <div class="col-12 col-md-5 col-lg-5" style="user-select: auto;">
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          ...
                          <textarea  class="form-control" name="note" style=" height:350px;"> {{$company->note}} </textarea>
                      ...
                      <div class="row" style="user-select: auto;">
                        <div class="col-12 col-md-12 col-lg-12" style="user-select: auto;">
                          ...
                          <input type="range" id="commission" name="commission" class="form-range" value="{{$company->commission}}"  min="0" max="100">
